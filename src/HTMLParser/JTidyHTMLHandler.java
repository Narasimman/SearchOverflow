...
public class Indexer {
	...
	public static void main(String[] args) throws Exception {
        ...
        new JCommander(indexObj, args);
		
//		if (args.length != 2) {
//			throw new Exception("Usage: java " + Indexer.class.getName()+ " <index dir> <data dir>");
//			}
		Path indexPath = FileSystems.getDefault().getPath(indexObj.indexDirPath);
		...
		int numIndexed = index(indexDir, indexObj.dataDir);
	...
	private static void indexFile(IndexWriter writer, File f)throws IOException 
			{
				...
				Document doc = parser.getDocument(new FileInputStream(f));
